...
import com.example.pagingwithroomexample.rest.API
import com.example.pagingwithroomexample.rest.ImagesApi
import com.example.pagingwithroomexample.room.ImageDao
import com.example.pagingwithroomexample.room.UserDb
...
class MainRepository(context: Context, var pageSize: Int, var prefetchDistance: Int = pageSize) : PixabayImagesRepository {
    ...
    override fun getImages(): PwcListing<ImageItem> {
        ...
        val livePagedList = LivePagedListBuilder(db.images().getUsers(), config)
    ...
    private fun refresh(): LiveData<NetworkState> {
        ...
        imagesApi.getImages(1, pageSize).enqueue(
